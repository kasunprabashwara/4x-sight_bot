...
from src.config import MT5_PATH, MT5_LOGIN, MT5_PASSWORD, MT5_SERVER, MT5_TIMEOUT, MT5_PORTABLE
import pandas as pd
import math
...
class MT5Wrapper:
    def __init__(self):
        """
        Initializes the MT5 instance using credentials from the config file.
        """
        self.path = MT5_PATH
